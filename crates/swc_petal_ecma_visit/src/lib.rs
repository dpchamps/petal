...
#[doc(hidden)]
pub extern crate swc_petal_ast;
...
macro_rules! noop_fold_type {
    ($name:ident, $N:tt) => {
        fn $name(&mut self, node: $crate::swc_petal_ast::$N) -> $crate::swc_petal_ast::$N {
            node
        }
    };
    () => {
...
macro_rules! noop_visit_type {
    ($name:ident, $N:tt) => {
        fn $name(&mut self, _: &$crate::swc_petal_ast::$N) {}
    };
    () => {
...
macro_rules! noop_visit_mut_type {
    ($name:ident, $N:ident) => {
        fn $name(&mut self, _: &mut $crate::swc_petal_ast::$N) {}
    };
    () => {
...
macro_rules! visit_obj_and_computed {
    () => {
        fn visit_member_expr(&mut self, n: &$crate::swc_petal_ast::MemberExpr) {
            n.obj.visit_with(self);
            if let $crate::swc_petal_ast::MemberProp::Computed(c) = &n.prop {
                c.visit_with(self);
            }
        }

        fn visit_super_prop_expr(&mut self, n: &$crate::swc_petal_ast::SuperPropExpr) {
            if let $crate::swc_petal_ast::SuperProp::Computed(c) = &n.prop {
                c.visit_with(self);
            }
        }
    };
...
macro_rules! visit_mut_obj_and_computed {
    () => {
        fn visit_mut_member_expr(&mut self, n: &mut $crate::swc_petal_ast::MemberExpr) {
            n.obj.visit_mut_with(self);
            if let $crate::swc_petal_ast::MemberProp::Computed(c) = &mut n.prop {
                c.visit_mut_with(self);
            }
        }

        fn visit_mut_super_prop_expr(&mut self, n: &mut $crate::swc_petal_ast::SuperPropExpr) {
            if let $crate::swc_petal_ast::SuperProp::Computed(c) = &mut n.prop {
                c.visit_mut_with(self);
            }
        }
    };
