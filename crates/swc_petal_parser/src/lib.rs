...
//! extern crate swc_petal_parser;
//! use swc_common::sync::Lrc;
//! use swc_common::{
//!     errors::{ColorConfig, Handler},
//!     FileName, FilePathMapping, SourceMap,
//! };
//! use swc_petal_parser::{lexer::Lexer, Parser, StringInput, Syntax};
//!
//! fn main() {
...
impl Syntax {
    ...
    #[cfg(feature = "typescript")]
    pub const fn typescript(self) -> bool {
        matches!(self, Syntax::Typescript(..) | Syntax::EsTypeAnnotations(..))
    }
...
macro_rules! expose {
    (
        ...
        /// instantiation of generics occur in `swc_petal_parser` crate.
        pub fn $name(
            fm: &SourceFile,
            syntax: Syntax,
            target: EsVersion,
